...
while True:
    ...
    if respuesta == 1:
       ...
       # saldoF = totDep - totRet (Este será el total total de todos los movimientos del banco pero me falló xd)        
        ...
        print(" - ELIMINAR CLIENTE - ") #Esto es para probar la impresión de datos, no es el punto 5 xdxd
        for i in range(cantClientes):
            ...
            print("Fecha depositos", clientes["fechaDe"][i],"\n")
            print("Fecha retiros", clientes["fechaRe"][i],"\n")
        print("Total: $", totDep)
        print("Total: ", totRet)
